...
void MovieDB::init() {
    ...
    m = new Movie(t, 1980, { "George Lucas" }, { "Mark Hamill", "Carrie Fisher", "Harrison Ford" }, {"Action", "Adventure", "Fantasy", "Science Fiction"}, desc, "sw");
    ...
    m = new Movie(t, 2022, {"Ryan Coogler"}, {"Letitia Wright", "Lupita Nyong'o", "Danai Gurira"}, {"Action", "Adventure", "Drama"}, desc, "bpwf");
    m_movies.push_back(m);
    ...
    m = new Movie(t, 1990, { "Chris Columbus" }, { "Macaulay Culkin", "Joe Pesci", "Daniel Stern" }, {"Holiday", "Comedy", "Family"}, desc, "home");
    m_movies.push_back(m);
    m_popular.push_back(m);
    m_slideshow.push_back(m);
    ...
    m = new Movie(t, 2004, { "Alfonso Cuaron" }, { "Daniel Radcliffe", "Emma Watson", "Rupert Grint" }, {"Adventure", "Family", "Fantasy"}, desc, "hp");
    m_movies.push_back(m);
    m_popular.push_back(m);

    t = "The Dark Knight";
    desc = "When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must fight injustice.";
    m = new Movie(t, 2008, { "Christopher Nolan" }, { "Christian Bale", "Heath Ledger", "Aaron Eckhart" }, {"Action", "Crime", "Drama"}, desc, "tdk");
    m_movies.push_back(m);
    m_popular.push_back(m);

    t = "Clueless";
    desc = "Cher, a high school student in Beverly Hills, must survive the ups and downs of adolescent life.";
    m = new Movie(t, 1995, { "Amy Heckerling" }, { "Alicia Silverstone", "Stacey Dash", "Brittany Murphy" }, {"Comedy", "Romance", "Teen Comedy"}, desc, "clue");
    m_movies.push_back(m);
    m_popular.push_back(m);

    t = "Everything Everywhere All at Once";
    desc = "An aging Chinese immigrant is swept up in an insane adventure.";
    m = new Movie(t, 2022, { "Dan Kwan", "Daniel Scheinert" }, { "Michelle Yeoh", "Stephanie Hsu", "Jamie Lee Curtis" }, {"Action", "Adventure", "Comedy"}, desc, "everything");
    m_movies.push_back(m);
    m_slideshow.push_back(m);

    t = "Nope";
    desc = "The residents of a lonely gulch in inland California bear witness to an uncanny and chilling discovery.";
    m = new Movie(t, 2022, {"Jordan Peele"}, {"Daniel Kaluuya", "Keke Palmer", "Steven Yeun"}, {"Horror", "Mystery", "Science Fiction"}, desc, "nope");
    m_movies.push_back(m);
    m_slideshow.push_back(m);

    t = "Elvis";
    desc = "The life of American music icon Elvis Presley.";
    m = new Movie(t, 2022, { "Baz Luhrmann" }, { "Tom Hanks", "Austin Butler", "Olivia DeJonge" }, { "Biography", "Drama", "Music" }, desc, "elvis");
    m_movies.push_back(m);
    m_slideshow.push_back(m);

    t = "Encanto";
    desc = "A Colombian teenage girl has to face the frustration of being the only member of her family without magical powers.";
    m = new Movie(t, 2021, { "Jared Bush", "Byron Howard", "Charise Castro Smith"}, {"Stephanie Beatriz", "Maria Cecilia Botero", "John Leguizamo"}, {"Animation", "Comedy", "Family"}, desc, "encanto");
    m_movies.push_back(m);
    m_slideshow.push_back(m);
}
